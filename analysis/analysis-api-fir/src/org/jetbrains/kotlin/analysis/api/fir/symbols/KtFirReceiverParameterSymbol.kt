...
internal class KtFirReceiverParameterSymbol(
    ...
    init {
        requireWithAttachment(firSymbol.fir.receiverParameter != null, { "$firSymbol doesn't have an extension receiver." }) {
    ...
    override val type: KtType by cached {
        firSymbol.receiverType(analysisSession.firSymbolBuilder)
            ?: errorWithAttachment("FirCallableSymbol doesn't have an extension receiver") {
                withFirEntry("callable", firSymbol.fir)
            }
    }
