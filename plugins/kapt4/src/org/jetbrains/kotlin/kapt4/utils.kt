...
internal inline fun <T, R> Iterable<T>.mapJList(f: (T) -> R?): JavacList<R> {
...
internal val PsiMethod.hasVarargs: Boolean
...
internal val PsiModifierListOwner.accessFlags: Int
    get() = when (this) {
