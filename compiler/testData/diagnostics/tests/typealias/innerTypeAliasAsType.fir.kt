...
fun test3(x: <!WRONG_NUMBER_OF_TYPE_ARGUMENTS!>Outer<!>.NestedAlias) = x
...
fun test7(x: <!WRONG_NUMBER_OF_TYPE_ARGUMENTS!>Outer<!>.GenericNestedAlias<Int>) = x
fun <T> test8(x: <!WRONG_NUMBER_OF_TYPE_ARGUMENTS!>Outer<!>.GenericNestedAlias<T>) = x
